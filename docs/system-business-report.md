...
- Xem trang đăng nhập, đăng ký, quên mật khẩu.
...
- Đăng nhập, đăng xuất, đổi/khôi phục mật khẩu.
...
2. Hệ thống gửi OTP hoặc token đặt lại mật khẩu.
3. Người dùng xác minh OTP.

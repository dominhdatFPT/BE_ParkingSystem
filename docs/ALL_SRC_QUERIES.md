...
### `src/main/java/com/swp/parking/service/UserService.java:26`

**Loại query:** Thao tác đọc `SELECT` kế thừa từ `JpaRepository`.

**Mục đích:** Lấy toàn bộ người dùng từ database.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **26**.
...
### `src/main/java/com/swp/parking/service/UserService.java:33`

**Loại query:** Thao tác đọc `SELECT` kế thừa từ `JpaRepository`.

**Mục đích:** Lấy một bản ghi người dùng theo khóa chính.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **33**.
...
### `src/main/java/com/swp/parking/service/UserService.java:51`

**Loại query:** Thao tác ghi `INSERT/UPDATE` kế thừa từ `JpaRepository`.

**Mục đích:** Lưu người dùng; Hibernate quyết định `INSERT` hoặc `UPDATE` theo trạng thái entity.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **51**.
...
### `src/main/java/com/swp/parking/service/UserService.java:55`

**Loại query:** Thao tác đọc `SELECT` kế thừa từ `JpaRepository`.

**Mục đích:** Lấy một bản ghi người dùng theo khóa chính.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **55**.
...
### `src/main/java/com/swp/parking/service/UserService.java:62`

**Loại query:** Thao tác ghi `INSERT/UPDATE` kế thừa từ `JpaRepository`.

**Mục đích:** Lưu người dùng; Hibernate quyết định `INSERT` hoặc `UPDATE` theo trạng thái entity.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **62**.
...
### `src/main/java/com/swp/parking/service/UserService.java:66`

**Loại query:** Thao tác kiểm tra tồn tại `EXISTS` kế thừa từ `JpaRepository`.

**Mục đích:** Kiểm tra bản ghi người dùng có tồn tại theo khóa chính hay không.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **66**.
...
### `src/main/java/com/swp/parking/service/UserService.java:69`

**Loại query:** Thao tác `DELETE` kế thừa từ `JpaRepository`.

**Mục đích:** Xóa người dùng theo khóa chính.

**Vị trí trong source:** `src/main/java/com/swp/parking/service/UserService.java`, bắt đầu tại dòng **69**.
